...
private:
	CBleeding(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBleeding(const CBleeding& rhs);
...
public:
	static CBleeding* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
