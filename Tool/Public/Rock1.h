...
BEGIN(Tool)
class CRock1 final: public CTool_Object
{
private:
	CRock1(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
...
public:
	static CRock1* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual CRock1* Clone(void* pArg);
