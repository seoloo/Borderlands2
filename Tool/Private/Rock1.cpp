...
void CRock1::Tick(_float fTimeDelta)
{
...
void CRock1::Late_Tick(_float fTimeDelta)
{
...
HRESULT CRock1::Add_Components()
{
    ...
    if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_Rock1"),
...
CRock1* CRock1::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    ...
    if (FAILED(pInstance->Initialize_Prototype()))
    {
        ...
        MSG_BOX("Failed to Create : CRock1");
    }

    return pInstance;
}

CRock1* CRock1::Clone(void* pArg)
{
    ...
    {
        Safe_Release(pInstance);
        MSG_BOX("Failed to Clone : CRock1");
    }
