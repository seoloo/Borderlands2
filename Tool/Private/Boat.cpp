...
HRESULT CBoat::Add_Components()
{
    ...
    if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_Boat"),
...
CBoat* CBoat::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    ...
    if (FAILED(pInstance->Initialize_Prototype()))
    {
        ...
        MSG_BOX("Failed to Create : CBoat");
    }

    return pInstance;
}

CBoat* CBoat::Clone(void* pArg)
{
