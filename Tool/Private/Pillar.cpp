...
HRESULT CPillar::Add_Components()
{
    /* Com_Renderer */
    ...
    if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_Pillar"),
...
HRESULT CPillar::Bind_ShaderResources()
{
...
CPillar* CPillar::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    ...
    if (FAILED(pInstance->Initialize_Prototype()))
    {
        ...
        MSG_BOX("Failed to Create : CPillar");
    }

    return pInstance;
}

CPillar* CPillar::Clone(void* pArg)
{
    ...
    {
        Safe_Release(pInstance);
        MSG_BOX("Failed to Clone : CPillar");
    }
