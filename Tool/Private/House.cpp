...
HRESULT CHouse::Add_Components()
{
    ...
    if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_House"),
...
HRESULT CHouse::Bind_ShaderResources()
{
...
CHouse* CHouse::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    ...
    if (FAILED(pInstance->Initialize_Prototype()))
    {
        ...
        MSG_BOX("Failed to Create : CHouse");
    }

    return pInstance;
}

CHouse* CHouse::Clone(void* pArg)
{
    ...
    {
        Safe_Release(pInstance);
        MSG_BOX("Failed to Clone : CHouse");
    }
