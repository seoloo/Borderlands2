...
CTool_Object_Icebox01::CTool_Object_Icebox01(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
    : CTool_Object(pDevice, pContext)
{
}

CTool_Object_Icebox01::CTool_Object_Icebox01(const CTool_Object_Icebox01& rhs)
    : CTool_Object(rhs)
{
}

HRESULT CTool_Object_Icebox01::Initialize_Prototype()
{
    return S_OK;
}

HRESULT CTool_Object_Icebox01::Initialize(void* pArg)
{
...
void CTool_Object_Icebox01::Tick(_float fTimeDelta)
{
...
void CTool_Object_Icebox01::Late_Tick(_float fTimeDelta)
{
...
HRESULT CTool_Object_Icebox01::Render()
{
...
void CTool_Object_Icebox01::Apply_Tool()
{
...
void CTool_Object_Icebox01::Key_Input()
{
    CGameInstance* pGameInstance = CGameInstance::Get_Instance();
    Safe_AddRef(pGameInstance);
...
HRESULT CTool_Object_Icebox01::Add_Components()
{
    /* Com_Renderer */
    ...
    if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_IceBlock01"),
...
HRESULT CTool_Object_Icebox01::Bind_ShaderResources()
{
...
CTool_Object_Icebox01* CTool_Object_Icebox01::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    CTool_Object_Icebox01* pInstance = new CTool_Object_Icebox01(pDevice, pContext);

    if (FAILED(pInstance->Initialize_Prototype()))
    {
        Safe_Release(pInstance);
        MSG_BOX("Failed to Create : CTool_Object_Icebox01");
    }

    return pInstance;
}

CTool_Object_Icebox01* CTool_Object_Icebox01::Clone(void* pArg)
{
    CTool_Object_Icebox01* pInstance = new CTool_Object_Icebox01(*this);

    if (FAILED(pInstance->Initialize(pArg)))
    {
        Safe_Release(pInstance);
        MSG_BOX("Failed to Clone : CTool_Object_Icebox01");
    }

    return pInstance;
}

void CTool_Object_Icebox01::Free()
{
    __super::Free();
