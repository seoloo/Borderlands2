...
HRESULT CLarge_Rock1::Add_Components()
{
    ...
    if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_Large_Rock1"),
...
CLarge_Rock1* CLarge_Rock1::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    ...
    if (FAILED(pInstance->Initialize_Prototype()))
    {
        ...
        MSG_BOX("Failed to Create : CLarge_Rock1");
    }

    return pInstance;
}

CLarge_Rock1* CLarge_Rock1::Clone(void* pArg)
{
    ...
    {
        Safe_Release(pInstance);
        MSG_BOX("Failed to Clone : CLarge_Rock1");
    }
