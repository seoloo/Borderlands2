...
CBarCounter::CBarCounter(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
    : CTool_Object(pDevice, pContext)
{
}

CBarCounter::CBarCounter(const CBarCounter& rhs)
    : CTool_Object(rhs)
{
}

HRESULT CBarCounter::Initialize_Prototype()
{
    return S_OK;
}

HRESULT CBarCounter::Initialize(void* pArg)
{
...
void CBarCounter::Tick(_float fTimeDelta)
{
...
void CBarCounter::Late_Tick(_float fTimeDelta)
{
...
HRESULT CBarCounter::Add_Components()
{
    /* Com_Renderer */
    ...
    if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_BarCounter"),
...
HRESULT CBarCounter::Bind_ShaderResources()
{
...
CBarCounter* CBarCounter::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    CBarCounter* pInstance = new CBarCounter(pDevice, pContext);

    if (FAILED(pInstance->Initialize_Prototype()))
    {
        Safe_Release(pInstance);
        MSG_BOX("Failed to Create : CBarCounter");
    }

    return pInstance;
}

CBarCounter* CBarCounter::Clone(void* pArg)
{
    CBarCounter* pInstance = new CBarCounter(*this);

    if (FAILED(pInstance->Initialize(pArg)))
    {
        Safe_Release(pInstance);
        MSG_BOX("Failed to Clone : CBarCounter");
    }

    return pInstance;
}

void CBarCounter::Free()
{
    __super::Free();
