...
HRESULT CForkLift::Add_Components()
{
    ...
    if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_ForkLift"),
...
CForkLift* CForkLift::Clone(void* pArg)
{
