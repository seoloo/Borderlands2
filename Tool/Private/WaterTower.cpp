...
HRESULT CWaterTower::Add_Components()
{
    ...
    if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_WaterTower"),
...
CWaterTower* CWaterTower::Clone(void* pArg)
{
