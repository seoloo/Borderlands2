#include "stdafx.h"
#include "..\Public\Thresher_Melee.h"
...
CThresher_Melee::CThresher_Melee(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CLandObject(pDevice, pContext)
{
}

CThresher_Melee::CThresher_Melee(const CThresher_Melee & rhs)
	: CLandObject(rhs)
{
}

HRESULT CThresher_Melee::Initialize_Prototype()
{
...
HRESULT CThresher_Melee::Initialize(void * pArg)
{
	...
	random_device rd;
	mt19937 gen(rd());
	uniform_int_distribution<int> Bury(9, 13);
	uniform_int_distribution<int> Attack(4, 8);
...
void CThresher_Melee::Tick(_float fTimeDelta)
{
...
void CThresher_Melee::Late_Tick(_float fTimeDelta)
{
...
HRESULT CThresher_Melee::Render()
{
...
void CThresher_Melee::State_Appear(_float fTimeDelta)
{
...
void CThresher_Melee::State_Attack(_float fTimeDelta)
{
	// 공격 : 4 ~ 8
...
void CThresher_Melee::State_Bury(_float fTimeDelta)
{
	// 9~ 13
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
	...
	if (m_pModelCom->Get_AnimEnd())
	{
		...
		if (m_pModelCom->Get_Animation()[m_iRandomBury]->Get_AnimEnd())
		{
			...
			if (m_iNumbering == 1)
			{
				if (m_bArmsDead)
				{
					dynamic_cast<CThresher*>(m_pObject)->Set_MeleeDead(true);
				}
			}
			g_MeleeNumber = 0;
...
HRESULT CThresher_Melee::Add_Components()
{
	/* Com_Renderer */
	...
	/* Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_ThresherMelee"),
...
HRESULT CThresher_Melee::Add_Parts()
{
	...
	CThresher_MeleeCollider::COLLIDERDESC			DescArmL1;
	...
	CThresher_MeleeCollider::COLLIDERDESC			DescArmL2;
	...
	CThresher_MeleeCollider::COLLIDERDESC			DescArmL3;
	...
	CThresher_MeleeCollider::COLLIDERDESC			DescArmL4;
	...
	CThresher_MeleeCollider::COLLIDERDESC			DescArmL5;
	...
	CThresher_MeleeCollider::COLLIDERDESC			DescArmL6;
	...
	CThresher_MeleeCollider::COLLIDERDESC			DescArmL7;
	...
	CThresher_MeleeCollider::COLLIDERDESC			DescArmL8;
	...
	CThresher_MeleeCollider::COLLIDERDESC			DescArmL9;
	...
	CThresher_MeleeCollider::COLLIDERDESC			DescArmL10;
	...
	CThresher_MeleeCollider::COLLIDERDESC			DescArmL11;
	...
	CThresher_MeleeCollider::COLLIDERDESC			DescArmL12;
	...
	CThresher_MeleeCollider::COLLIDERDESC			DescArmL13;
	...
	CThresher_MeleeCollider::COLLIDERDESC			DescArmL14;
	...
	CThresher_MeleeCollider::COLLIDERDESC			DescArmL15;
	...
	pPartArmL1 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_MeleeCollider"), &DescArmL1);
	pPartArmL2 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_MeleeCollider"), &DescArmL2);
	pPartArmL3 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_MeleeCollider"), &DescArmL3);
	pPartArmL4 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_MeleeCollider"), &DescArmL4);
	pPartArmL5 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_MeleeCollider"), &DescArmL5);
	pPartArmL6 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_MeleeCollider"), &DescArmL6);
	pPartArmL7 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_MeleeCollider"), &DescArmL7);
	pPartArmL8 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_MeleeCollider"), &DescArmL8);
	pPartArmL9 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_MeleeCollider"), &DescArmL9);
	pPartArmL10 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_MeleeCollider"), &DescArmL10);
	pPartArmL11 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_MeleeCollider"), &DescArmL11);
	pPartArmL12 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_MeleeCollider"), &DescArmL12);
	pPartArmL13 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_MeleeCollider"), &DescArmL13);
	pPartArmL14 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_MeleeCollider"), &DescArmL14);
	pPartArmL15 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_MeleeCollider"), &DescArmL15);
	pPartArmL16 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_MeleeCollider"), &DescArmL16);
...
HRESULT CThresher_Melee::Bind_ShaderResources()
{
...
CThresher_Melee * CThresher_Melee::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CThresher_Melee*	pInstance = new CThresher_Melee(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Created : CThresher_Melee");
	}

	return pInstance;
}

CGameObject * CThresher_Melee::Clone(void * pArg)
{
	CThresher_Melee*	pInstance = new CThresher_Melee(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Cloned : CThresher_Melee");
	}

	return pInstance;
}

void CThresher_Melee::Free()
{
	__super::Free();
