...
CRoland::CRoland(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CLandObject(pDevice, pContext)
{
}

CRoland::CRoland(const CRoland & rhs)
	: CLandObject(rhs)
{
}

HRESULT CRoland::Initialize_Prototype()
{
...
HRESULT CRoland::Initialize(void * pArg)
{
...
void CRoland::Tick(_float fTimeDelta)
{
...
void CRoland::Late_Tick(_float fTimeDelta)
{
...
HRESULT CRoland::Add_Components()
{
	/* Com_Renderer */
	...
	/* Com_Model */
	if (FAILED(__super::Add_Component(g_CurLevel, TEXT("Prototype_Component_Model_Roland"),
...
HRESULT CRoland::Bind_ShaderResources()
{
...
CRoland * CRoland::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRoland*	pInstance = new CRoland(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Created : CRoland");
	}

	return pInstance;
}

CGameObject * CRoland::Clone(void * pArg)
{
	CRoland*	pInstance = new CRoland(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Cloned : CRoland");
	}
