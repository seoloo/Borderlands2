...
CThresher_Arm::CThresher_Arm(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CLandObject(pDevice, pContext)
{
}

CThresher_Arm::CThresher_Arm(const CThresher_Arm & rhs)
	: CLandObject(rhs)
{
}

HRESULT CThresher_Arm::Initialize_Prototype()
{
...
HRESULT CThresher_Arm::Initialize(void * pArg)
{
	...
	random_device rd;
	mt19937 gen(rd());
	uniform_int_distribution<int> Bury(18, 24);
	uniform_int_distribution<int> Attack(8, 13);
...
void CThresher_Arm::Tick(_float fTimeDelta)
{
...
void CThresher_Arm::Late_Tick(_float fTimeDelta)
{
...
void CThresher_Arm::State_Appear(_float fTimeDelta)
{

	m_pModelCom->SetUp_Animation(29, true);
	...
	if (m_pModelCom->Get_AnimEnd())
	{
		...
		if (m_pModelCom->Get_Animation()[29]->Get_AnimEnd())
		{
...
void CThresher_Arm::State_Attack(_float fTimeDelta)
{
	// 공격 : 8, 9, 10, 11, 12, 13,16, 17
...
void CThresher_Arm::State_Bury(_float fTimeDelta)
{
	// 들어감 18 ~ 28
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
	...
	if (m_pModelCom->Get_AnimEnd())
	{
		...
		if (m_pModelCom->Get_Animation()[m_iRandomBury]->Get_AnimEnd())
		{
			...
			if (m_iNumbering == 1)
			{
				if (m_bArmsDead)
				{
					dynamic_cast<CThresher*>(m_pObject)->Set_ArmDead(true);
				}
			}
			g_ArmNumber = 0;
...
HRESULT CThresher_Arm::Add_Components()
{
	/* Com_Renderer */
	...
	/* Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_ThresherArm"),
...
HRESULT CThresher_Arm::Add_Parts()
{
	...
	CThresher_ArmCollider::COLLIDERDESC			DescArmL1;
	...
	CThresher_ArmCollider::COLLIDERDESC			DescArmL2;
	...
	CThresher_ArmCollider::COLLIDERDESC			DescArmL3;
	...
	CThresher_ArmCollider::COLLIDERDESC			DescArmL4;
	...
	CThresher_ArmCollider::COLLIDERDESC			DescArmL5;
	...
	CThresher_ArmCollider::COLLIDERDESC			DescArmL6;
	...
	CThresher_ArmCollider::COLLIDERDESC			DescArmL7;
	...
	CThresher_ArmCollider::COLLIDERDESC			DescArmL8;
	...
	CThresher_ArmCollider::COLLIDERDESC			DescArmL9;
	...
	CThresher_ArmCollider::COLLIDERDESC			DescArmL10;
	...
	CThresher_ArmCollider::COLLIDERDESC			DescArmL11;
	...
	CThresher_ArmCollider::COLLIDERDESC			DescArmL12;
	...
	CThresher_ArmCollider::COLLIDERDESC			DescArmL13;
	...
	CThresher_ArmCollider::COLLIDERDESC			DescArmL14;
	...
	CThresher_ArmCollider::COLLIDERDESC			DescArmL15;
	...
	pPartArmL1 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_ArmCollider"), &DescArmL1);
	pPartArmL2 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_ArmCollider"), &DescArmL2);
	pPartArmL3 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_ArmCollider"), &DescArmL3);
	pPartArmL4 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_ArmCollider"), &DescArmL4);
	pPartArmL5 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_ArmCollider"), &DescArmL5);
	pPartArmL6 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_ArmCollider"), &DescArmL6);
	pPartArmL7 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_ArmCollider"), &DescArmL7);
	pPartArmL8 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_ArmCollider"), &DescArmL8);
	pPartArmL9 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_ArmCollider"), &DescArmL9);
	pPartArmL10 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_ArmCollider"), &DescArmL10);
	pPartArmL11 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_ArmCollider"), &DescArmL11);
	pPartArmL12 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_ArmCollider"), &DescArmL12);
	pPartArmL13 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_ArmCollider"), &DescArmL13);
	pPartArmL14 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_ArmCollider"), &DescArmL14);
	pPartArmL15 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_ArmCollider"), &DescArmL15);
	pPartArmL16 = pGameInstance->Clone_GameObject(TEXT("Prototype_GameObject_Thresher_ArmCollider"), &DescArmL16);
...
HRESULT CThresher_Arm::Bind_ShaderResources()
{
...
CThresher_Arm * CThresher_Arm::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CThresher_Arm*	pInstance = new CThresher_Arm(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Created : CThresher_Arm");
	}

	return pInstance;
}

CGameObject * CThresher_Arm::Clone(void * pArg)
{
	CThresher_Arm*	pInstance = new CThresher_Arm(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Cloned : CThresher_Arm");
	}

	return pInstance;
}

void CThresher_Arm::Free()
{
	__super::Free();
