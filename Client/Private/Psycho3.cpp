...
CPsycho3::CPsycho3(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CLandObject(pDevice, pContext)
{
}

CPsycho3::CPsycho3(const CPsycho3 & rhs)
	: CLandObject(rhs)
{
}

HRESULT CPsycho3::Initialize_Prototype()
{
...
HRESULT CPsycho3::Initialize(void * pArg)
{
...
void CPsycho3::Tick(_float fTimeDelta)
{
...
void CPsycho3::Late_Tick(_float fTimeDelta)
{
...
void CPsycho3::Idle_Mode(_float fTimeDelta)
{
...
void CPsycho3::Appear_Mode(_float fTimeDelta)
{
	m_pModelCom->Play_Animation(fTimeDelta);
...
void CPsycho3::Walk_Mode(_float fTimeDelta)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
	m_pModelCom->Play_Animation(fTimeDelta);
...
void CPsycho3::Attack_Mode(_float fTimeDelta)
{
	m_pModelCom->Play_Animation(fTimeDelta);
...
void CPsycho3::Attacked_Mode(_float fTimeDelta)
{
	m_pModelCom->Play_Animation(fTimeDelta);
...
void CPsycho3::Dead_Mode(_float fTimeDelta)
{
	m_pModelCom->Play_Animation(fTimeDelta);
...
HRESULT CPsycho3::Add_Components()
{
	/* Com_Renderer */
...
HRESULT CPsycho3::Bind_ShaderResources()
{
...
HRESULT CPsycho3::Collision_Object()
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
CPsycho3 * CPsycho3::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CPsycho3*	pInstance = new CPsycho3(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Created : CPsycho3");
	}

	return pInstance;
}

CGameObject * CPsycho3::Clone(void * pArg)
{
	CPsycho3*	pInstance = new CPsycho3(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Cloned : CPsycho3");
	}
