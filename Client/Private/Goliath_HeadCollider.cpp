#include "stdafx.h"
#include "..\Public\Goliath_HeadCollider.h"

#include "GameInstance.h"

CGoliath_HeadCollider::CGoliath_HeadCollider(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CGoliath_HeadCollider::CGoliath_HeadCollider(const CGoliath_HeadCollider & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGoliath_HeadCollider::Initialize_Prototype()
{
...
HRESULT CGoliath_HeadCollider::Initialize(void * pArg)
{
...
void CGoliath_HeadCollider::Tick(_float fTimeDelta)
{
...
void CGoliath_HeadCollider::Late_Tick(_float fTimeDelta)
{
	__super::Late_Tick(fTimeDelta);
}

HRESULT CGoliath_HeadCollider::Render()
{
...
HRESULT CGoliath_HeadCollider::Add_Components()
{
	/* Com_Renderer */
...
HRESULT CGoliath_HeadCollider::Bind_ShaderResources()
{
...
CGoliath_HeadCollider * CGoliath_HeadCollider::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CGoliath_HeadCollider*	pInstance = new CGoliath_HeadCollider(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Created : CGoliath_HeadCollider");
	}

	return pInstance;
}

CGameObject * CGoliath_HeadCollider::Clone(void * pArg)
{
	CGoliath_HeadCollider*	pInstance = new CGoliath_HeadCollider(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Cloned : CGoliath_HeadCollider");
	}

	return pInstance;
}

void CGoliath_HeadCollider::Free()
{
	__super::Free();
