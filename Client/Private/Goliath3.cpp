...
CGoliath3::CGoliath3(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CLandObject(pDevice, pContext)
{
}

CGoliath3::CGoliath3(const CGoliath3 & rhs)
	: CLandObject(rhs)
{
}

HRESULT CGoliath3::Initialize_Prototype()
{
...
HRESULT CGoliath3::Initialize(void * pArg)
{
...
void CGoliath3::Tick(_float fTimeDelta)
{
...
void CGoliath3::Late_Tick(_float fTimeDelta)
{
...
void CGoliath3::Appear_Mode(_float fTimeDelta)
{
...
void CGoliath3::Idle_Mode(_float fTimeDelta)
{
	m_pModelCom->Play_Animation(fTimeDelta);
...
void CGoliath3::Walk_Mode(_float fTimeDelta)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
void CGoliath3::Attack_Mode(_float fTimeDelta)
{
	m_pModelCom->Play_Animation(fTimeDelta);
...
void CGoliath3::Dead_Mode(_float fTimeDelta)
{
	m_pModelCom->Play_Animation(fTimeDelta);
...
HRESULT CGoliath3::Add_Components()
{
	/* Com_Renderer */
...
HRESULT CGoliath3::Bind_ShaderResources()
{
...
HRESULT CGoliath3::Collision_Object()
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
CGoliath3 * CGoliath3::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CGoliath3*	pInstance = new CGoliath3(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Created : CGoliath3");
	}

	return pInstance;
}

CGameObject * CGoliath3::Clone(void * pArg)
{
	CGoliath3*	pInstance = new CGoliath3(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Cloned : CGoliath3");
	}
