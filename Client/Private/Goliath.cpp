...
CGoliath::CGoliath(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CLandObject(pDevice, pContext)
{
}

CGoliath::CGoliath(const CGoliath & rhs)
	: CLandObject(rhs)
{
}

HRESULT CGoliath::Initialize_Prototype()
{
...
HRESULT CGoliath::Initialize(void * pArg)
{
	...
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(37.f, 0.f, 70.f, 1.f));
...
void CGoliath::Tick(_float fTimeDelta)
{
...
void CGoliath::Late_Tick(_float fTimeDelta)
{
...
void CGoliath::Appear_Mode(_float fTimeDelta)
{
...
void CGoliath::Idle_Mode(_float fTimeDelta)
{
	m_pModelCom->Play_Animation(fTimeDelta);
...
void CGoliath::Walk_Mode(_float fTimeDelta)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
void CGoliath::Attack_Mode(_float fTimeDelta)
{
...
void CGoliath::Attacked_Mode(_float fTimeDelta)
{
	//32
...
void CGoliath::Dead_Mode(_float fTimeDelta)
{
	m_pModelCom->Play_Animation(fTimeDelta);
...
HRESULT CGoliath::Add_Components()
{
	/* Com_Renderer */
...
HRESULT CGoliath::Bind_ShaderResources()
{
...
HRESULT CGoliath::Collision_Object()
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
CGoliath * CGoliath::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CGoliath*	pInstance = new CGoliath(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Created : CGoliath");
	}

	return pInstance;
}

CGameObject * CGoliath::Clone(void * pArg)
{
	CGoliath*	pInstance = new CGoliath(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Cloned : CGoliath");
	}
