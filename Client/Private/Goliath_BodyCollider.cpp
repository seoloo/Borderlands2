#include "stdafx.h"
#include "..\Public\Goliath_BodyCollider.h"

#include "GameInstance.h"

CGoliath_BodyCollider::CGoliath_BodyCollider(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CGoliath_BodyCollider::CGoliath_BodyCollider(const CGoliath_BodyCollider & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGoliath_BodyCollider::Initialize_Prototype()
{
...
HRESULT CGoliath_BodyCollider::Initialize(void * pArg)
{
...
void CGoliath_BodyCollider::Tick(_float fTimeDelta)
{
...
void CGoliath_BodyCollider::Late_Tick(_float fTimeDelta)
{
	__super::Late_Tick(fTimeDelta);
}

HRESULT CGoliath_BodyCollider::Render()
{
...
HRESULT CGoliath_BodyCollider::Add_Components()
{
	/* Com_Renderer */
...
HRESULT CGoliath_BodyCollider::Bind_ShaderResources()
{
...
CGoliath_BodyCollider * CGoliath_BodyCollider::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CGoliath_BodyCollider*	pInstance = new CGoliath_BodyCollider(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Created : CGoliath_BodyCollider");
	}

	return pInstance;
}

CGameObject * CGoliath_BodyCollider::Clone(void * pArg)
{
	CGoliath_BodyCollider*	pInstance = new CGoliath_BodyCollider(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Cloned : CGoliath_BodyCollider");
	}

	return pInstance;
}

void CGoliath_BodyCollider::Free()
{
	__super::Free();
