#include "stdafx.h"
#include "..\Public\Psycho_BodyCollider.h"

#include "GameInstance.h"

CPsycho_BodyCollider::CPsycho_BodyCollider(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CPsycho_BodyCollider::CPsycho_BodyCollider(const CPsycho_BodyCollider & rhs)
	: CGameObject(rhs)
{
}

HRESULT CPsycho_BodyCollider::Initialize_Prototype()
{
...
HRESULT CPsycho_BodyCollider::Initialize(void * pArg)
{
...
void CPsycho_BodyCollider::Tick(_float fTimeDelta)
{
...
void CPsycho_BodyCollider::Late_Tick(_float fTimeDelta)
{
	__super::Late_Tick(fTimeDelta);
}

HRESULT CPsycho_BodyCollider::Render()
{
...
HRESULT CPsycho_BodyCollider::Add_Components()
{
	/* Com_Renderer */
...
HRESULT CPsycho_BodyCollider::Bind_ShaderResources()
{
...
CPsycho_BodyCollider * CPsycho_BodyCollider::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CPsycho_BodyCollider*	pInstance = new CPsycho_BodyCollider(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Created : CPsycho_BodyCollider");
	}

	return pInstance;
}

CGameObject * CPsycho_BodyCollider::Clone(void * pArg)
{
	CPsycho_BodyCollider*	pInstance = new CPsycho_BodyCollider(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Cloned : CPsycho_BodyCollider");
	}

	return pInstance;
}

void CPsycho_BodyCollider::Free()
{
	__super::Free();
