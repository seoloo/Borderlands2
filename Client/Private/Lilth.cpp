...
CLilth::CLilth(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CLandObject(pDevice, pContext)
{
}

CLilth::CLilth(const CLilth & rhs)
	: CLandObject(rhs)
{
}

HRESULT CLilth::Initialize_Prototype()
{
...
HRESULT CLilth::Initialize(void * pArg)
{
	...
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(13.f, 0.f, 20.f, 1.f));

	return S_OK;
}

void CLilth::Tick(_float fTimeDelta)
{
...
void CLilth::Late_Tick(_float fTimeDelta)
{
...
HRESULT CLilth::Add_Components()
{
	...
	/* Com_Model */
	if (FAILED(__super::Add_Component(g_CurLevel, TEXT("Prototype_Component_Model_Lilth"),
...
HRESULT CLilth::Bind_ShaderResources()
{
...
CLilth * CLilth::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CLilth*	pInstance = new CLilth(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Created : CLilth");
	}

	return pInstance;
}

CGameObject * CLilth::Clone(void * pArg)
{
	CLilth*	pInstance = new CLilth(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed to Cloned : CLilth");
	}
