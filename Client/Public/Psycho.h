...
BEGIN(Client)
class CPsycho final : public CLandObject
{
public:
...
private: 
	CPsycho(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CPsycho(const CPsycho& rhs);
	virtual ~CPsycho() = default;
...
public:
	static CPsycho* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
