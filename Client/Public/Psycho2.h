...
BEGIN(Client)
class CPsycho2 final : public CLandObject
{
public:
...
private: 
	CPsycho2(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CPsycho2(const CPsycho2& rhs);
	virtual ~CPsycho2() = default;
...
public:
	static CPsycho2* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
