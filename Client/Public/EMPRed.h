...
private:
	CEMPRed(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEMPRed(const CEMPRed& rhs);
	virtual ~CEMPRed() = default;
...
public:
	static CEMPRed* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
