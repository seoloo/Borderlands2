...
BEGIN(Client)
class CPsycho3 final : public CLandObject
{
public:
...
private: 
	CPsycho3(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CPsycho3(const CPsycho3& rhs);
	virtual ~CPsycho3() = default;
...
private:
	...
	_vector m_vPreviousPos = { XMVectorSet(0.f,0.f,0.f,0.f) };
	_vector m_vCurrentPos = { XMVectorSet(0.f,0.f,0.f,0.f) };
...
public:
	static CPsycho3* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
