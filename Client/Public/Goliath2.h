...
BEGIN(Client)
class CGoliath2 final : public CLandObject
{
public:
...
private: 
	CGoliath2(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CGoliath2(const CGoliath2& rhs);
	virtual ~CGoliath2() = default;
...
public:
	static CGoliath2* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
