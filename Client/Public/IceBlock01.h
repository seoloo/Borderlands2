...
BEGIN(Client)
class CIceBlock01 final : public CGameObject
{
public:
...
private:
	CIceBlock01(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CIceBlock01(const CIceBlock01& rhs);
	virtual ~CIceBlock01() = default;
...
public:
	static CIceBlock01* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
