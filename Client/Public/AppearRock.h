...
BEGIN(Client)
class CAppearRock final : public CGameObject
{
public:
...
private:
	CAppearRock(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CAppearRock(const CAppearRock& rhs);
	virtual ~CAppearRock() = default;
...
public:
	static CAppearRock* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
