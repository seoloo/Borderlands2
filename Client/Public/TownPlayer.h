...
class CTownPlayer final : public CLandObject
{
public:
...
private:
	CTownPlayer(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTownPlayer(const CTownPlayer& rhs);
	virtual ~CTownPlayer() = default;
...
public:
	static CTownPlayer* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
