...
BEGIN(Client)
class CThresher_Melee : public CLandObject
{
public:
...
private: 
	CThresher_Melee(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CThresher_Melee(const CThresher_Melee& rhs);
	virtual ~CThresher_Melee() = default;
...
public:
	static CThresher_Melee* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
