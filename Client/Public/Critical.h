...
private:
	CCritical(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CCritical(const CCritical& rhs);
	virtual ~CCritical() = default;
...
public:
	static CCritical* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
