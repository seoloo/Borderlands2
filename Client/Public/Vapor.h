...
private:
	CVapor(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CVapor(const CVapor& rhs);
	virtual ~CVapor() = default;
...
public:
	static CVapor* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
