...
private:
	CEnergy(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEnergy(const CEnergy& rhs);
...
public:
	static CEnergy* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
