...
BEGIN(Client)
class CThresher_Arm2 : public CLandObject
{
public:
...
private: 
	CThresher_Arm2(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CThresher_Arm2(const CThresher_Arm2& rhs);
	virtual ~CThresher_Arm2() = default;
...
public:
	static CThresher_Arm2* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
