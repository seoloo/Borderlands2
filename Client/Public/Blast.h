...
BEGIN(Client)
class CBlast final : public CGameObject
{
public:
...
private:
	CBlast(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBlast(const CBlast& rhs);
...
public:
	static CBlast* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
